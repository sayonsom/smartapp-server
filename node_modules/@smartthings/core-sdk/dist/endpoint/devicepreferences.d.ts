 ...
 */
export declare type PreferenceId = string;
...
export declare type DevicePreferenceBase = IntegerDevicePreference | NumberDevicePreference | BooleanDevicePreference | StringDevicePreference | EnumerationDevicePreference;
export declare type DevicePreferenceCreate = DevicePreferenceBase & {
    /**
...
export declare type DevicePreference = DevicePreferenceBase & {
...
export declare class DevicePreferencesEndpoint extends Endpoint {
    constructor(config: EndpointClientConfig);
    list(namespace?: string): Promise<DevicePreference[]>;
    get(id: PreferenceId): Promise<DevicePreference>;
    create(devicePreference: DevicePreferenceCreate): Promise<DevicePreference>;
    update(id: PreferenceId, devicePreference: DevicePreference): Promise<DevicePreference>;
    createTranslations(preferenceId: PreferenceId, localization: PreferenceLocalization): Promise<PreferenceLocalization>;
    getTranslations(preferenceId: PreferenceId, locale: LocaleTag): Promise<PreferenceLocalization>;
    listTranslations(preferenceId: PreferenceId): Promise<LocaleReference[]>;
    updateTranslations(preferenceId: PreferenceId, localization: PreferenceLocalization): Promise<PreferenceLocalization>;
}
//# sourceMappingURL=devicepreferences.d.ts.map